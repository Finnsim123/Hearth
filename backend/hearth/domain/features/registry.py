...
register(Recipe(Role.PERSON,    X.person,     1440, 0.0, slow_sensor=True, suffixes=("home_last", "home_frac")))
register(Recipe(Role.FOCUS,     X.focus,      10,   0.0, suffixes=("on_last",)))
register(Recipe(Role.ALARM_TIME, X.alarm_time, 1440, 0.0, slow_sensor=True, suffixes=("minutes_until", "imminent")))
